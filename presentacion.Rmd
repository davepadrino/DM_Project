...
## Se convierte la matriz en un tipo especial de matriz llamada "Real Rating Matrix" Especial de la biblioteca Recommenderlab, una vez en ese estado o tipo de dato se pasa a realizar el proceso de recomendacion
```{r, eval=FALSE}
...
## Creacion y apliciacion de funcion especial para generar datos de salida.
```{r, eval=FALSE}
